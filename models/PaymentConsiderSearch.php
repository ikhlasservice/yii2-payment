...
/**
 * PaymentConsiderSearch represents the model behind the search form about `backend\modules\payment\models\Payment`.
 */
class PaymentConsiderSearch extends Payment
{
    /**
     * @inheritdoc
     */
